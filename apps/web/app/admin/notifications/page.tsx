        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-1 max-w-3xl text-sm text-slate-600 sm:text-base">
              Monitor portfolio-wide statement generation, risk alerts, billing events, and platform activity.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">
              <div className="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Critical</div>
              <div className="mt-1 text-2xl font-bold text-slate-900">{criticalCount}</div>
            </div>
            <div className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">
