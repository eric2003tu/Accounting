    ...
    <div className="space-y-6">
      ...
      <DataTable<SaleRecord>
        ...
        columns={buildSalesColumns({
          onEditAction: (sale) => setSaleToEdit(sale),
          onDeleteAction: (sale) => setSaleToDelete(sale),
        })}
      ...
      <DeleteConfirmationModal
        ...
        onCancelAction={() => setSaleToDelete(null)}
      ...
      <SalesEditModal
        isOpen={!!saleToEdit}
        sale={saleToEdit}
        onCancelAction={() => setSaleToEdit(null)}
        onSaveAction={handleSaveSale}
      />
    </div>
  );
}
