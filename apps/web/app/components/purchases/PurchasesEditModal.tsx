...
type PurchasesEditModalProps = {
  ...
  onCancelAction: () => void;
  onSaveAction: (purchase: PurchaseRecord) => void;
};
...
export default function PurchasesEditModal({ isOpen, purchase, onCancelAction, onSaveAction }: PurchasesEditModalProps) {
