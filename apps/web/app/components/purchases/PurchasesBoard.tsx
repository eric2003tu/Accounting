    ...
    <div className="space-y-6">
      ...
      <DataTable<PurchaseRecord>
        ...
        columns={buildPurchaseColumns({
          onEditAction: (purchase) => setPurchaseToEdit(purchase),
          onDeleteAction: (purchase) => setPurchaseToDelete(purchase),
        })}
      ...
      <DeleteConfirmationModal
        ...
        onCancelAction={() => setPurchaseToDelete(null)}
      ...
      <PurchasesEditModal
        ...
        onCancelAction={() => setPurchaseToEdit(null)}
        onSaveAction={handleSavePurchase}
      />
    </div>
  );
}
