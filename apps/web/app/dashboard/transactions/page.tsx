  ...
  2: [
    {
      ...
      ref: 'RFF-TXN-001',
      transactionType: 'income',
      counterparty: 'Kigali Supermarket',
      description: 'Maize flour bulk delivery',
      category: 'Income',
      amount: 3750,
      currency: 'USD',
      taxRate: 0,
    ...
    },
    {
      ...
      ref: 'RFF-TXN-002',
      transactionType: 'expense',
      counterparty: 'Farmers Coop',
      description: 'Grain purchase',
      category: 'Expenses',
      amount: 2250,
      currency: 'USD',
      taxRate: 0,
      ...
      paymentMethod: 'Bank Transfer',
      loanAmount: 0,
      notes: 'Raw materials for processing',
    },
    {
      id: 3,
      businessId: 2,
      ...
      ref: 'RFF-TXN-003',
      transactionType: 'income',
      counterparty: 'Restaurant Chain',
      description: 'Premium rice supply',
      category: 'Income',
      amount: 1000,
      currency: 'USD',
      taxRate: 0,
  ...
  5: [
    {
      ...
      description: 'Daily sales - snacks & beverages',
      category: 'Income',
      amount: 850,
      currency: 'USD',
      taxRate: 0,
    ...
    },
    {
      ...
      ref: 'KMR-TXN-002',
      transactionType: 'expense',
      counterparty: 'SnackCo',
      description: 'Chips restock',
      category: 'Expenses',
      amount: 500,
      currency: 'USD',
      taxRate: 0,
    ...
    },
    {
      ...
      ref: 'KMR-TXN-003',
      transactionType: 'expense',
      counterparty: 'Aqua Rwanda',
      description: 'Mineral water stock',
      category: 'Expenses',
      amount: 150,
      currency: 'USD',
      taxRate: 0,
...
function TransactionsPageContent() {
  ...
  const [selectedBusinessId, setSelectedBusinessId] = React.useState<number>(initialBusinessId || 0);
  ...
  React.useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const defaultBusinessId = (list && list[0] && Number(list[0].id)) || 0;
        setSelectedBusinessId(initialBusinessId && list.some((b: any) => Number(b.id) === initialBusinessId) ? initialBusinessId : defaultBusinessId);
      } catch (err) {
        console.error('Failed to load businesses for transactions', err);
  ...
  const selectedBusiness = businessOptions.find((business) => Number(business.id) === selectedBusinessId) ?? businessOptions[0] ?? null;
...
export default function TransactionsPage() {
  return (
    <Suspense fallback={<BrandLoadingScreen title="Loading transactions" subtitle="Preparing cashflow and journal activity for the selected business." />}>
