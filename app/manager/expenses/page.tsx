...
function ExpensesPageContent() {
  ...
  const handleBusinessChange = (businessId: number) => {
    ...
    router.replace(`/manager/expenses?businessId=${businessId}`);
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-start">
        <Link
          href={`/manager/expenses/add?businessId=${selectedBusiness.id}`}
...
export default function ExpensesPage() {
  return (
    <Suspense fallback={<BrandLoadingScreen title="Loading expenses" subtitle="Preparing expense records for your assigned business." />}>
      <ExpensesPageContent />
    </Suspense>
  );
}
