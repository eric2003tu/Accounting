        ...
        <div ref={menuRef} className="relative">
          ...
          >
            <div className="hidden sm:flex flex-col items-end">
              <p className="text-sm font-medium text-slate-900 font-semibold">Arielle Mukamana</p>
          ...
          {profileMenuOpen && (
            <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg border border-slate-200 shadow-[0_10px_30px_rgba(15,23,42,0.15)] z-50">
              ...
              <div className="border-b border-slate-200 p-4">
                <p className="text-sm font-semibold text-slate-900">Arielle Mukamana</p>
                <p className="text-xs text-slate-600 mt-1">arielle.mukamana@acme.com</p>
