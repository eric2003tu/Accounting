...
import { Bell, CheckCircle2, Clock3, Sparkles, TriangleAlert, Wallet } from 'lucide-react';
...
export default function NormalNotificationsPage() {
  const { notifications, unreadCount, markAsRead, markAllAsRead } = useNotifications('normal');
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-1 max-w-3xl text-sm text-slate-600 sm:text-base">
              Keep up with personal account updates, owner application progress, and security reminders.
            </p>
          </div>
