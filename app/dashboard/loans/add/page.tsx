...
export default function AddLoanPage() {
  ...
  const selectedBusiness = ownerBusinesses.find((business) => String(business.id) === businessId);
      ...
      <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_10px_28px_rgba(15,23,42,0.08)] lg:p-6">
        ...
        <div className="relative space-y-3">
          ...
          <p className="max-w-3xl text-sm text-slate-600 sm:text-base">
            Choose whether this is a loan received or offered, then capture the full financial profile for repayment schedules, covenants, and reporting.
          </p>
        </div>
      </div>
        ...
        <div className="space-y-6">
          <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_10px_28px_rgba(15,23,42,0.08)] sm:p-6">
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Set business context and direction before entering financial details.</p>
              </div>
            </div>
              ...
              <label className="space-y-2 md:col-span-2">
                ...
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                  ...
                  >
                    ...
                    Loan Received
                    <p className="mt-1 text-xs font-normal text-slate-500">Borrowing from a lender into your business.</p>
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    ...
                    Loan Offered
                    <p className="mt-1 text-xs font-normal text-slate-500">Credit extended by your business to a customer.</p>
                  </button>
                </div>
              </label>
            </div>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_10px_28px_rgba(15,23,42,0.08)] sm:p-6">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              {direction === 'offered' && (
                <label className="space-y-2">
                  <span className="text-sm font-medium text-slate-700">Borrower Phone Number <span className="text-red-500">*</span></span>
                  <input
                    type="tel"
                    value={borrowerPhone}
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_10px_28px_rgba(15,23,42,0.08)] sm:p-6">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <label className="space-y-2">
                <span className="text-sm font-medium text-slate-700">Repayment Method</span>
                <div className="relative">
                  <select
                    value={status}
