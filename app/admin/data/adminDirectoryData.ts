...
export const adminUsers: AdminUser[] = [
  ...
  {
    id: 6,
    name: 'Claudette Ishimwe',
    email: 'claudette@acme.com',
    phone: '+250 722 445 331',
    role: 'Accountant',
    status: 'Active',
    mfa: 'Enabled',
    lastLogin: '2026-04-11 09:15',
    joinedAt: '2025-03-01',
    department: 'Finance',
  },
  {
    id: 7,
    name: 'David Mwangi',
    email: 'david.mwangi@acme.com',
    phone: '+254 721 556 889',
    role: 'Accountant',
    status: 'Active',
    mfa: 'Enabled',
    lastLogin: '2026-04-11 08:45',
    joinedAt: '2024-12-15',
    department: 'Finance',
  },
  {
    id: 8,
    name: 'Mercy Nyambura',
    email: 'mercy.nyambura@acme.com',
    phone: '+254 723 667 772',
    role: 'Accountant',
    status: 'Active',
    mfa: 'Pending',
    lastLogin: '2026-04-10 14:30',
    joinedAt: '2026-01-20',
    department: 'Finance',
  },
  {
    id: 9,
    name: 'Charles Mutua',
    email: 'charles.mutua@acme.com',
    phone: '+254 713 228 556',
    role: 'Accountant',
    status: 'Active',
    mfa: 'Enabled',
    lastLogin: '2026-04-11 07:20',
    joinedAt: '2025-02-03',
    department: 'Finance',
  },
  {
    id: 10,
    name: 'Florence Okello',
    email: 'florence.okello@acme.com',
    phone: '+256 701 234 567',
    role: 'Accountant',
    status: 'Active',
    mfa: 'Disabled',
    lastLogin: '2026-04-09 11:50',
    joinedAt: '2025-04-12',
    department: 'Finance',
  },
  {
    id: 11,
    name: 'Patrick Kimani',
    email: 'patrick.kimani@acme.com',
    phone: '+254 722 889 443',
    role: 'Accountant',
    status: 'Active',
    mfa: 'Enabled',
    lastLogin: '2026-04-11 10:05',
    joinedAt: '2024-11-18',
    department: 'Finance',
  },
];
