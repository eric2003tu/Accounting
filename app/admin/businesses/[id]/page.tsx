    ...
    <div className="space-y-4 sm:space-y-6">
      <section className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-4 shadow-[0_10px_28px_rgba(15,23,42,0.08)] sm:p-5 lg:p-6">
        ...
        <div className="relative flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="space-y-2">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-900 sm:text-3xl">Business Financial Profile</h1>
              <p className="mt-1 text-sm text-slate-600 sm:text-base">
                Full operating, registration, ownership, and financial performance view for this business.
              </p>
            </div>
          </div>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-[0_10px_28px_rgba(15,23,42,0.08)] sm:p-5 lg:p-6">
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Primary account owner and identity controls.</p>
              </div>
            </div>
      ...
      <section className="grid grid-cols-1 gap-4 sm:gap-6 xl:grid-cols-2">
        <SimpleChart
          ...
          data={business.financials.revenueTrend}
          type="line"
        />
        <SimpleChart
          title="Expense Allocation"
          description="Monthly spend by major category"
          data={business.financials.expenseBreakdown}
          type="pie"
        />
      </section>
